...
def start_anpr(input_files):
    ...
    model = OCR(
        modelFile=r"D:\intelligent_traffic_management_system\PROJECT\models\binary_128_0.50_ver3.pb",
        labelFile=r"D:\intelligent_traffic_management_system\PROJECT\models\binary_128_0.50_labels_ver2.txt"
    )
